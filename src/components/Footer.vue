        ...
        <v-row class="px-3">
          <v-col class="col-12 col-md-6 pr-md-10">
            ...
            <v-row class="contato mt-4">
              <div>
                <span class="rotulo"> Endereço: </span> Av. Adhemar de Barros,
                000, Vila Adyana, São José dos Campos/SP - 12241-040
              </div>
              <div>
                <span class="rotulo">Contato: </span> (12) 98227-9588 / (12)
                982050-5060
              </div>
              <div>
                <span class="rotulo">E-mail: </span> contato@bigstore.com.br
              </div>
            </v-row>
            <v-row class="newsletter mt-3 d-none d-md-block">
              <div class="campo">
                <input
                  type="text"
                  placeholder="Assine nossa Newsletter, digite seu melhor e-mail."
                />
                <v-btn>Assinar</v-btn>
              </div>
            </v-row>
    ...
    <div class="rodape-inferior">
      <v-container class="d-flex justify-space-between">
        ...
        <div class="desenvolvedor">
          <a href="https://rodolfo-santos.com/" target="_blank"
            >Powered by Rodolfo Santos</a
          >
        </div>
      </v-container>
    </div>
