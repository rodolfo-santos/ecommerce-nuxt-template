...
export default class SubHeader extends Vue {
  ...
  @Prop({ default: require('~/assets/images/site-images/banner__subheader.jpg') }) public background!: string;
  @Prop() public readonly breadcrumbs!: object[];

  get urlBackground(): string {
    if (this.background === '') {
      return require('~/assets/images/site-images/banner__subheader.jpg');
    }
